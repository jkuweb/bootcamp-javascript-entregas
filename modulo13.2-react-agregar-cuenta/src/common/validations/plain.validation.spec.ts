import { isDateAfterToday, isEmailWellFormated, isPositiveNumber, isStringValueInformed, isValidIban, isValueNotNullOrUndefined } from "./plain.validation";
...
describe('plain validation', () => {
	describe('isValidIban specs', () => {
		...
		it('should be return true when iban is formatted with no spaces is valid', () => {
			// Arrange
		...
		it('should be return false when iban is invalid', () => {
			// Arrnge
		...
		it('should be return false when iban is empty', () => {
			// Arrange
			const iban = '';
	...
	describe('isEmailWellFormed specs', () => {
		it('should return true when email is well formed', () => {
			...
			// Act
			const result = isEmailWellFormated(email);
	...
	describe('isStringValueInformed specs', () => {
		it('should return trur when field is informed', () => {
			// Arrange 
			const field = 'test';
